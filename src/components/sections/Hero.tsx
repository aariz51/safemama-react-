...
const siteConfig = {
  videoUrl: "https://res.cloudinary.com/dclcda1je/video/upload/v1756622668/Firefly_Gentle_floating_motion_of_the_soft_orbs_and_elements_subtle_gradient_shifts_peaceful_andc1rpiwgj.mp4",
  hero: {
    badge: "Trusted by 50,000+ Expecting Mothers",
    title: "Your AI Pregnancy Safety Companion",
    subtitle: "Instantly check if food, medicine, and products are safe during pregnancy. Get personalized recommendations you can trust.",
    cta: {
      primary: {
        label: "Get SafeMama Free",
...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden">
      ...
      {/* Hero Content - FIXED MOBILE-FIRST ORDERING */}
                ...
                {mockupImages.map((image, index) => (
                  ...
                  >
                    <motion.img
                      src={image.src}
                      alt={image.alt}
                      className={`h-64 sm:h-80 lg:h-96 w-auto object-contain ${index === 1 ? 'scale-110' : ''}`}
                      loading="lazy"
                      animate={{
                        y: [0, -10, 0]
                      }}
